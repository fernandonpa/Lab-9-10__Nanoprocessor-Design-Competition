...
HD_PWD='C:/Vivado/Lab9-10/Lab9-10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Nano_Processor_with_out.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Nano_Processor_with_out.tcl -notrace

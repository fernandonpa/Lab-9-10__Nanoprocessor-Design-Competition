...
HD_PWD='C:/Vivado/Lab9-10/Lab9-10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Nano_Processor_with_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Nano_Processor_with_out.tcl
